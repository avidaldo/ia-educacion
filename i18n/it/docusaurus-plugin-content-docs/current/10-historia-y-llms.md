...
- [Perceptron](https://www.youtube.com/watch?v=l-9ALe3U-Fg) (1957)
- Rete Hopfield (1982)
- Backpropagazione (1986)
- [LeNet-5](https://www.youtube.com/watch?v=H0oEr40YhrQ) (1998) (riconoscimento cifre)

- **Deep Learning**: sottocampo dell'intelligenza artificiale che si concentra sullo sviluppo di reti neurali profonde (reti neurali con molti strati nascosti) e con cui si sviluppa il boom dell'intelligenza artificiale.
-AlexNet (2012)
...
**Caratteristiche fondamentali degli agenti**:
Sono definiti dalla loro **autonomia** per agire a lungo termine, **proattività** per prendere l'iniziativa, **reattività** per adattarsi all'ambiente, **capacità sociale** di interagire e **uso di strumenti** (API, Internet, ecc.).
