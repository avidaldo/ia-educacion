...
- **Gems** (Gemini): saved instructions that you can activate in each chat. Especially useful for creating [Socratic or guided tutors](../41-cases-use/02-guided-learning.mdx).
...
This example shows how a well-designed prompt can become a reusable wizard for generating tests. More details in [Tests for Moodle](../41-cases-use/01-tests-moodle.mdx).
