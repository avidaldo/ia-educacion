...
- [LeNet-5](https://www.youtube.com/watch?v=H0oEr40YhrQ) (1998) (digit recognition)

- **Deep Learning**: Subfield of AI that focuses on the development of deep neural networks (neural networks with many hidden layers) and with which the AI ​​boom develops.
-AlexNet (2012)
...
They are defined by their **autonomy** to act in the long term, **proactivity** to take the initiative, **reactivity** to adapt to the environment, **social capacity** to interact and the **use of tools** (APIs, Internet, etc.).
