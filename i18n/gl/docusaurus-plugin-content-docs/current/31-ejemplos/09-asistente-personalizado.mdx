...
- **Gems** (Gemini): instrucións gardadas que podes activar en cada chat. Especialmente útiles para crear [titores socráticos ou guiados](../41-casos-uso/02-guided-learning.mdx).
...
Este exemplo amosa como un prompt ben deseñado pode converterse nun asistente reutilizable para xerar tests. Máis detalles en [Tests para Moodle](../41-casos-uso/01-tests-moodle.mdx).
